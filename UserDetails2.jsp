...
String s1  =(String)session2.getAttribute("bname");
String s2 = (String) session2.getAttribute("bauthor");
int s3 = (Integer)session2.getAttribute("bprice");


String s4 = request.getParameter("txt9");

session2.setAttribute("bquantity", s4);
