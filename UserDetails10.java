...
/**
 * Servlet implementation class UserDetails10
 */
@WebServlet("/UserDetails10")
public class UserDetails10 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				String s6 = (String) session3.getAttribute("bquantity");  // book quantity
				String s7 = (String)session3.getAttribute("bookid");  // book id
